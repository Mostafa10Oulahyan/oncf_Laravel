        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            @if($commandes->isEmpty())
                ...
                <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                    ...
                    <a href="{{ url('/') }}"
                        class="inline-block bg-oncf-blue text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-700 transition">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <div class="bg-gradient-to-r from-oncf-blue to-blue-600 px-6 py-4 text-white">
                                <div class="flex justify-between items-center">
                                    <div>
                                        <h3 class="text-lg font-semibold">Commande
                                            #{{ str_pad($commande->id, 6, '0', STR_PAD_LEFT) }}</h3>
                                        <p class="text-blue-100 text-sm">
                                            {{ \Carbon\Carbon::parse($commande->date_comm)->format('d/m/Y à H:i') }}</p>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-sm text-blue-100">{{ $commande->billets->count() }} billet(s)</div>
                                        <div class="text-xl font-bold">
                                            {{ number_format($commande->billets->sum(function ($b) {
                        return $b->voyage->effective_price * $b->qte; }), 2) }}
                                            DH</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                @foreach($commande->billets as $billet)
                                            <div class="p-6 hover:bg-gray-50 transition">
                                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                                    ...
                                                    <div class="flex-1">
                                                        <div class="flex items-center gap-6">
                                                            ...
                                                            <div class="text-center">
                                                                <div class="text-3xl font-bold text-gray-800">{{ $billet->voyage->heureDepart }}
                                                                </div>
                                                            ...
                                                            <div class="flex flex-col items-center flex-1">
                                                                ...
                                                                <div class="w-full border-t-2 border-gray-300 relative">
                                                                    <div
                                                                        class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white px-2">
                                                                        <svg class="w-5 h-5 text-oncf-blue" fill="none" stroke="currentColor"
                                                                            viewBox="0 0 24 24">
                                                            ...
                                                            <div class="text-center">
                                                                <div class="text-3xl font-bold text-gray-800">
                                                                    {{ $billet->voyage->heureDarrivee }}</div>
                                                        ...
                                                        <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                                            <div>
                                                                ...
                                                                <div class="font-semibold text-gray-800">{{ $billet->prenom_passager }}
                                                                    {{ $billet->nom_passager }}</div>
                                                            </div>
                                                            <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="font-semibold text-oncf-blue">{{ $billet->voyage->code_voyage }}
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <span class="text-gray-500">Prix</span>
                                                                <div class="font-bold text-gray-800">
                                                                    {{ number_format($billet->voyage->effective_price, 2) }} DH</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- QR Code -->
                                                    <div
                                                        class="flex flex-col items-center justify-center border-l-2 border-dashed border-gray-200 pl-6">
                                                        <div class="w-24 h-24">
                                                            <?php 
                                                            $qrData = "ONCF Billet\n";
                                    ...
                                    $qrData .= "Prix: " . number_format($billet->voyage->effective_price, 2) . " DH";
                                                        ...
                                                        {{-- Delete Button --}}
                                                        <form action="{{ route('billets.delete', $billet->id) }}" method="POST" class="mt-4" onsubmit="return confirm('Êtes-vous sûr de vouloir annuler ce billet ?')">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="flex items-center gap-1.5 text-xs font-semibold text-red-600 hover:text-red-800 transition">
                            ...
                            <div class="bg-gray-50 px-6 py-4 border-t">
                                <button onclick="window.print()"
                                    class="w-full bg-oncf-blue text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition flex items-center justify-center">
            ...
            <div class="mt-8 text-center">
                <a href="{{ url('/') }}"
                    class="inline-flex items-center text-oncf-blue hover:text-blue-700 font-medium transition">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
